            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-blue-800 text-sm">
                  Try our live chat widget (bottom right) for instant
                  assistance, or check our{" "}
                  <Link
                    href="/faq"
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 mt-2">
                  Select the category that best matches your request so we can
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, systemLogs: e.target.value })
                  }
                ...
                />
                <p className="text-xs text-slate-500 mt-2">
                  Automatically linked from the app - please keep for
                  troubleshooting.
                </p>
              </div>
            ...
            <div className="mt-8 pt-8 border-t border-slate-200">
              ...
              <ul className="space-y-3 text-sm text-slate-600">
                ...
                <li className="flex gap-3">
                  <span className="text-blue-600 font-bold">✓</span>
                  <span>
                    Critical security and billing issues receive priority
                    handling
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="text-blue-600 font-bold">✓</span>
                  <span>
                    Average response time: 4-6 hours for urgent issues
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 py-12">
            ...
            <div className="text-center space-y-3 text-sm text-slate-400">
              ...
              <p>
                ...
                Stripe Inc. (USA) and Cryptomus (International).
              </p>
