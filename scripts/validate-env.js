...
async function main() {
    ...
    if (errors.length === 0) {
        console.log('✅ Environment validation passed! ✅ All configurations look good!');
        if (warnings.length === 0) {
            console.log('🎉 No warnings - environment is perfectly configured!');
        } else {
            console.log('⚠️  Environment is functional but consider addressing warnings for optimal security.');
        }
        process.exit(0);
    } else {
